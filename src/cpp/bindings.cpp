...
NODE_MODULE_INITIALIZER(Local<Object> exports,
    ...
    exports->Set(context, String::NewFromUtf8(isolate, "MatrixMultiply").ToLocalChecked(), FunctionTemplate::New(isolate, MatrixMultiply)->GetFunction(context).ToLocalChecked()).FromJust();
}
